...
//    }
    ...
    public RestResponse mergechunks(Long companyId, String fileMd5, int chunkTotal, UploadFileParamsDto uploadFileParamsDto) {
        ...
        try {
            try {
                ...
                xingchenPlusException.cast("创建临时合并文件出错");
            }
            ...
            try( RandomAccessFile raf_write  =new RandomAccessFile(tempMergeFile, "rw")) {
                ...
                xingchenPlusException.cast("合并文件过程出错");
            }
            ...
            try {
                ...
                if (!fileMd5.equals(mergeMd5Hex)) {
                    ...
                    xingchenPlusException.cast("合并文件校验不通过");
                }
            } catch (IOException e) {
                log.debug("合并文件校验出错,文件路径:{},原始文件md5:{}", tempMergeFile.getAbsolutePath(), fileMd5);
                xingchenPlusException.cast("合并文件校验出错");
            }
    ...
    public MediaFiles getFileById(String id) {
        ...
        if(mediaFiles==null){
            xingchenPlusException.cast("文件不存在");
        }
        String url = mediaFiles.getUrl();
        if(StringUtils.isEmpty(url)){
            xingchenPlusException.cast("文件还没有处理，请稍后预览");
        }
    ...
    */
    private File[] checkChunkStatus(String fileMd5,int chunkTotal ){
        ...
        for (int i = 0; i < chunkTotal; i++) {
            ...
            try {
                ...
                e.printStackTrace();
                xingchenPlusException.cast("创建分块临时文件出错"+e.getMessage());
            }
    ...
    public File downloadFileFromMinIO(File file, String bucket, String objectName){
        ...
        try(
            ...
            e.printStackTrace();
            xingchenPlusException.cast("查询分块文件出错");
        }
        return null;
    }
    ...
    public void addMediaFilesToMinIO(String filePath, String bucket, String objectName){
        try {
            ...
            xingchenPlusException.cast("文件上传到文件系统失败");
        }
    }
    //将文件上传到分布式文件系统
    private void addMediaFilesToMinIO(byte[] bytes, String bucket, String objectName) {
        ...
        try {
            ...
            xingchenPlusException.cast("上传文件到文件系统出错");
        }
    }
